...
class Header extends React.Component {
    ...
    constructor(props){
        super(props);
        this.state = {logo: require('./../../images/allimg/Tlogos2.png')};
    }
    ...
    <li ><a href={"https://www.facebook.com/people/Targefy/61563843562779/?mibextid=ZbWKwL"} className="fa fa-facebook" style={{backgroundColor:'#bb0000',color:'white'}}/></li>
    <li><a href={"https://www.linkedin.com/company/targefy-digital-marketing-agency/"} className="fa fa-linkedin" style={{backgroundColor:'#bb0000',color:'white'}}/></li>
    <li><a href={"https://www.instagram.com/targefy.digital/?igsh=OW1laW54eWNpbjVx"} className="fa fa-instagram" style={{backgroundColor:'#bb0000',color:'white'}}/></li>
    <li><a href={"mailto:help@targefy.com"} className="fa fa-envelope" style={{backgroundColor:'#bb0000',color:'white'}}/></li>
    <li><a href={"https://wa.me/0097 1552 013554"} className="fa fa-whatsapp" style={{backgroundColor:'#bb0000',color:'white'}}/></li>
</ul>
                                            </div>
