...
export default function Whatsapp() {
  ...
  const [messages, setMessages] = useState([
    {
      author: 'Targefy',
      text1: 'Hi there 👋\n\n',
      text:"Send your website link 🔗 for a free audit!",
  ...
  const handleSendMessage = () => {
    if (chatInput.trim()) {
      ...
      const phoneNumber = ' +971545681182'; // Update this with the desired phone number
      ...
      <div id="whatsapp-chat" className={isChatOpen ? '' : 'hide'}>
        <div className="header-chat">
          <div className="head-home">
            ...
            <p>
              <span className="whatsapp-name">Targefy</span>
              <br />
              <small>Online</small>
            </p>
          </div>
