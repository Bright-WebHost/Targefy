...
const images = [
    require('./../../images/allimg/aboutpage.webp'),
    require('./../../images/allimg/aboutpage1.webp'),
    require('./../../images/allimg/aboutpage.webp'),
    require('./../../images/allimg/aboutpage1.webp'),
]
                                ...
                                <div className="col-lg-7 col-md-7">
                                    <div className="m-about-containt text-black p-t80">
                                        <div className="m-about-years bg-moving" style={{backgroundImage:"url(" + bnr1 + ")"}}>
                                            ...
                                            <h3 className="font-weight-600">  Drive Growth with<span style={{color:'#bb0000'}}> Effective</span>  Branding </h3>
                                        </div>
                                        {/* <h3 className="font-weight-600">  Drive Growth with<span style={{color:'#bb0000'}}> Effective</span>  Branding </h3> */}
                                        <p className='p-t30'>Welcome to Targefy, where digital innovation meets precision marketing. We are a dedicated team of digital marketing experts passionate about transforming your online presence and driving measurable success. Our mission is to empower businesses to reach their full potential through data-driven strategies, creative solutions, and relentless dedication to excellence.</p>
